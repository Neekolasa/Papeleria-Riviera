                  ...
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-5 col-sm-5 ">
                        <input type="text" id="categoria-name" required="required" minlength='4' name="cat" class="form-control " placeholder="Minímo 4 carácteres">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-5 col-sm-5 ">
                        <input type="text" id="descripcion-name" minlength='5' placeholder="Minímo 5 carácteres" name="descripcion" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <div class="col-md-6 col-sm-6 offset-md-3">
                        <button type="submit" class="btn btn-success">Enviar <i class="fa fa-check"></i></button>
