...
<html lang="es">
  ...
  <body class="nav-md">
                  ...
                  <div class="x_content">
                    ...
                    <table id="" class="table table-striped table-bordered dt-responsive nowrap datatable" cellspacing="0" width="100%">
                      ...
                      <tbody id="tabla_usuarios">
                        ...
                        <!-- INFORMACION LLENADA CON datos_usuarios.php -->
                        <?php include_once("cont/datos_usuarios.php"); ?>
    ...
    <div class="modal fade bs-example-modal-lg editar_usuario_modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id='usuarios_mod' data-parsley-validate class='form-horizontal form-label-left'>
