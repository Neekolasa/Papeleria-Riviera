...
if (isset($_REQUEST['proceso'])) {
		...
		if ($respuesta == "editar_inventario") {
            ...
            $modal = "";
			//echo $id;
			$consulta = "SELECT productos.id_producto, TRIM(replace(productos.nombre,productos.marca,'')) as nombre, productos.marca,productos.descripcion, productos.precio_unidad, categoria.nombre as categoria FROM productos JOIN categoria on productos.fk_categoria = categoria.id WHERE id_producto = '$id'";
			...
			$modal.= "
			                    ...
			                    <div class='item form-group'>
			                      <label class='col-form-label col-md-3 col-sm-3 label-align'>Nombre peoducto 
			                      </label>
		...
		elseif ($respuesta == "modificar") {
			...
			$consulta = "UPDATE productos SET nombre = '$nombre $marca', marca = '$marca', descripcion = '$descripcion', precio_unidad = $precio, fk_categoria = $categoria WHERE id_producto = $id ";
